        ...
        <div class="row g-4">
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 text-center p-4">
                    <div class="bg-success-soft text-success rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"
                        style="width:100px;height:100px;font-size:2.5rem;">
                        <i class="fa-solid fa-calculator"></i>
                    </div>
                    <h5 class="fw-bold mb-1">{{ Auth::user()->name }}</h5>
                    <p class="text-muted small mb-1">{{ Auth::user()->email }}</p>
                    <span class="badge bg-success-subtle text-success rounded-pill px-3 py-1">Accountant</span>
                    <hr class="my-3">
