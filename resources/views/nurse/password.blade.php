        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <div class="card border-0 shadow-sm rounded-4 mt-3 p-3">
                    <h6 class="small fw-bold mb-3 text-muted text-uppercase">Password Requirements</h6>
                    <ul class="list-unstyled mb-0 small">
                        <li class="mb-1"><i class="fa-solid fa-check text-success me-2"></i>At least 8 characters long</li>
                        <li class="mb-1"><i class="fa-solid fa-check text-success me-2"></i>Contains uppercase and lowercase letters</li>
                        <li class="mb-1"><i class="fa-solid fa-check text-success me-2"></i>Contains at least one number</li>
                        <li><i class="fa-solid fa-check text-success me-2"></i>Contains a special character (e.g. !, @, #)</li>
                    </ul>
                </div>
            </div>
        </div>
